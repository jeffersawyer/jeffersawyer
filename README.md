...
📊 Статистика GitHub:![Uploading api.svg…]()
      ...
      >
        <title id="titleId">Joe Peach's GitHub Stats, Rank: C</title>
        <desc id="descId">Total Stars Earned: 0, Total Commits in 2025 : 7, Total PRs: 0, Total Issues: 0, Contributed to (last year): 0</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 250.5222850889935;
      }
    }
